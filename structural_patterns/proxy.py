"""Имеется абстрактный класс изображения, класс изображения и класс Proxy-изображения.
Последний полностью повторяет функционал замещаемого класса, собирает действия и """
...
class ImageProxy(ImageBase):
    """ Заместитель изображения. Откладывает выполнение операций над изображением до момента его сохранения."""
